...
public class HolderActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(de.android.R.layout.activity_holder);
        mToolbar = (Toolbar) findViewById(de.android.R.id.toolbar_actionbar);
    ...
    public void openFragment(Class<? extends Fragment> fragment, String[] data){
        ...
        try {
            ...
            fragmentManager.beginTransaction().replace(de.android.R.id.container, frag)
                    .commit();
    ...
    public void onBackPressed() {
        Fragment fragment = getSupportFragmentManager().findFragmentById(de.android.R.id.container);
        ...
        switch (requestCode) {
            case 1:
                ...
                if (!foundfalse){
                    ...
                    Toast.makeText(HolderActivity.this, getResources().getString(de.android.R.string.permissions_required), Toast.LENGTH_SHORT)
                            .show();
                }
                break;
            default:
